...
\begin{enumerate}
    \item Analisi testo:
    \begin{subenumerate}
        \item Indicazione di tempo: siamo a fine anno ``Almanacchi per l'anno nuovo?''
        \item Domanda diretta: ``credete che sarà felice quest'anno nuovo?''
        \item Risposta: L'anno futuro sarà meglio di quelli passati
            \begin{itemize}
                \item Gli anni passati non sono belli, ma il futuro lo sarà
                \item Paradosso: non gli piacerebbe rivivere un vecchio anno; risposta contraria alle risposte precedenti
            \end{itemize}
        \item Il venditore da 20 anni spera, ogni fine anno, che l'anno a venire sarà più bello di
            quello precedente, ma nessuno dei 20 precedenti secondo lui è stato bello:
                \begin{itemize}
                    \item Paradosso: il venditore ogni anno si illude che l'anno dopo possa essere
                        più bello $\rightarrow$ non si accumula mai esperienza
                \end{itemize}
        \item Domanda: ``La vità è una cosa bella?''
        \item Risposta: ``Cotesto si sa.''
            \begin{itemize}
                \item Paradoso: come puoi supporre che la vita sia bella se non rivivresti nessuno
                dei tuoi ultimi 20 anni?
            \end{itemize}
        \item Riflessione: ``Non tornereste voi a vivere cotesti vent’anni, e anche tutto il tempo 
            passato, cominciando da che nasceste?''
        \item Il venditore ha il desiderio di tornare indietro
        \item ``Ti piacerebbe rifare la vita uguale a quella che hai fatto fin'ora?''
        \item Il venditore risponde di no
        \item ``Rifaresti la vita di un altro? Credi che un altro non abbia fatto fatiche? Credi che qualcuno accetterebbe?''
        \item Il venditore continua a declinare
        \item Domanda diretta: ``Che vita vorresti fare allora?''
        \item Il venditore risponde ``Una vita come capita''
        \item ``Una vita ignota?''
        \item Risponde di sì
        \item Altra riflessione: se nessuno vorrebbe rivivere la propria vita, allora tutti hanno
            avuto dolore. Ciò significa che tutti hanno avuto più male che bene nella vita.
            La ``vita bella'' non è la vita già vissuta, ma quella futura (nonostante le delusioni
            del passato).
        \item Ultima domanda: ``L'anno prossimo sarà ancora felice?''
        \item ``Speriamo''
        \item Finale ciclico tra un anno e l'altro: ogni anno si spera che il prossimo sia migliore
            del precedente
    \end{subenumerate}

    \item Osservazioni:
        \begin{itemize}
            \item È l'unica operetta con tratti veritieri, è tutto realistico senza nulla di
                sovrannaturale (è una scena comune)
            \item È il passeggere che sprona il venditore ad arrivare a una riflessione molto
                articolata (Leopardi si rappresenta nel passeggere)
            \item Il venditore rappresenta l'opinione comune, mentre il passeggere ha come
                obiettivo destabilizzarla:\\
                Il passeggere mette in crisi il venditore tramire delle domande, portando lui
                stesso a dubitare delle sue stesse risposte e a procedere con una riflessione
                sulla vita
        \end{itemize}
...
\begin{multicols}{2}
    ...
    {\begin{itemize}
        \footnotesize
        \citem[v.1]{Passata è la tempesta} Sentenza di pericolo di morte (tempesta) che ora è alle spalle
        \citem[vv.1-2]{tempesta // festa} rima che dà l'idea di un pericolo alle spalle che
        fa tornare gioia
        ...
        \citem[vv.11-15]{Artigiano [...] fassi [...] vien fuori [...] femminetta} È un chiasmo tra verbo e predicato: entrambi escono e si riappropriano dello spazio esterno
        ...
        \citem[vv.25-27]{Si rallegra ogni core. / Sí dolce, sí gradita / quand'è, com'or, la vita?} Questo momento è il più dolce di e gradito di tutta la vita
...
\end{multicols}
\begin{enumerate}
    \item Metrica: canzone di tre strofe di endecasillabi e settenari variamente rimati, senza
        uno schema regolare. L'ultimo verso di ogni strofa rima sempre con uno precedente.
    \item Analisi: descrizione $\rightarrow$ riflessione $\rightarrow$ sentenza morale:
        \begin{subenumerate}
            \item Momento molto gioioso dopo il temporale
            \item Con ciclicità si riprende a fare ciò che era stato bruscamente interrotto
            \item La quiete dopo la tempesta è il sollievo dopo una grande paura
            \item Non si ha nulla in più dopo il sollievo, ma si ha il sollievo di non aver perso nulla
        \end{subenumerate}
    \item Riflessione:
        \begin{subenumerate}
            \item 5 domane retoriche sarcastiche che affermano la dolcezza del sollievo.
            \item[Zibaldone 1:] Un evento con la stessa probabilità di avvenire, quando è bene
                non consideriamo valida quella percentuale, mentre quando l'evento è nefasto
                la consideriamo come se l'evento fosse sicuro che accada quasi certamente
            \item[Zibaldone 2:] Nel momento in cui la vita diventa insopportabile e vedi la
                morte negli occhi, ti riattacchi alla vita come mai prima d'ora
            \item[Genere umano 3:] La Natura ha bisogno di far paura alla vita, così
                da poterci far riattaccare ad essa, anche per poco, e farsi consolare dalla
                Natura stessa per non averti ucciso;
        \end{subenumerate}
    \item Sentenza morale:
        \begin{itemize}
            \item[Zibaldone 4:] Se non ci fosse la tempesta, non sapremmo neanche cosa sarebbe
                il bel tempo, così come il male dal bene, la morte dalla vita.
        \end{itemize}
\end{enumerate}
...
\begin{multicols}{2}
    \noindent
    \poetry{
        1. & \textit{\quad La donzelletta vien dalla campagna,}\\
        & \textit{in sul calar del sole,}\\
        & \textit{col suo fascio dell’erba, e reca in mano}\\
        & \textit{un mazzolin di rose e di viole,}\\
        5. & \textit{onde, siccome suole,}\\
        & \textit{ornare ella si appresta}\\
        & \textit{dimani, al dí di festa, il petto e il crine.}\\
        & \textit{Siede con le vicine}\\
        & \textit{su la scala a filar la vecchierella,}\\
        10. & \textit{incontro lá dove si perde il giorno;}\\
        & \textit{e novellando vien del suo buon tempo,}\\
        & \textit{quando ai dí della festa ella si ornava,}\\
        & \textit{ed ancor sana e snella}\\
        & \textit{solea danzar la sera intra di quei}\\
        15. & \textit{ch’ebbe compagni dell’etá piú bella.}\\
        & \textit{Giá tutta l’aria imbruna,}\\
        & \textit{torna azzurro il sereno, e tornan l’ombre}\\
        & \textit{giú da’ colli e da’ tetti,}\\
        & \textit{al biancheggiar della recente luna.}\\
        20. & \textit{Or la squilla dá segno}\\
        & \textit{della festa che viene;}\\
        & \textit{ed a quel suon diresti}\\
        & \textit{che il cor si riconforta.}\\
        & \textit{I fanciulli gridando}\\
        25. & \textit{su la piazzuola in frotta,}\\
    ...
    {\begin{itemize}
        ...
        \citem[v.43]{Garzoncello scherzoso,} Evocativo: Leopardi si rivolge a un ragazzo allegro
