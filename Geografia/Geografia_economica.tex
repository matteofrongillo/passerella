...
\figbox{
    \includegraphics[width=.6\textwidth]{bipolarismo.png}
}
...
Dal documento: \href{https://github.com/matteofrongillo/passerella/blob/main/Geografia/Pass_03a_GlobalizzazioneXX-XXI-A_22-23.pdf}{La geografia del comportamento}
