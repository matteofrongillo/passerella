...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}
        ...
        \draw[thick, red, ->] (0,4) -- (7,4);
        \draw[thick, red,] (0,4.25) -- (0,3.75);
        \draw[thick, darkgreen, ->] (1,3) -- (7,3);
        \draw[thick, darkgreen,] (1,3.25) -- (1,2.75);
        \draw[thick, blue, ->] (2,2) -- (7,2);
        \draw[thick, blue,] (2,2.25) -- (2,1.75);
        \draw[thick, orange, ->] (3,1) -- (7,1);
        \draw[thick, orange] (3,1.25) -- (3,0.75);


        % Add labels for each section
        \node[anchor=west, red] at (7.5, 4) {A) \underline{Commercio materie prime} $\rightarrow$ settore I};
        \node[anchor=west, darkgreen] at (7.5, 3) {B) \underline{Delocalizzazione della produzione} $\rightarrow$ settore II};
        \node[anchor=west, blue] at (7.5, 2) {C) \underline{Gestione internazionale dei servizi} $\rightarrow$ settore III};
        \node[anchor=west, orange] at (7.5, 1) {D) \underline{Gruppi complessi} (I + II + III)};
